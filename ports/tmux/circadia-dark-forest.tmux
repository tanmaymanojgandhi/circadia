...
set -g status-right "#[bg=#242a25,fg=#9fa9a1] %Y-%m-%d #[fg=#838d85]|#[fg=#c4ccc5,bold] %H:%M #[bg=#83b384,fg=#131714,bold] #h "

# Window status
set -g window-status-format "#[bg=#1a1e1b,fg=#9fa9a1]  #I:#W  "
set -g window-status-current-format "#[bg=#242a25,fg=#83b384,bold]  #I:#W  "
