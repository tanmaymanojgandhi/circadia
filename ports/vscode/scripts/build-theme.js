...
function buildTheme(modeKey, mode) {
  ...
  return {
    ...
    colors: {
      ...
      "editor.selectionBackground": isDark ? `${ui.bg_element.hex}bb` : `${ui.bg_element.hex}cc`,
      "editor.selectionHighlightBackground": isDark ? `${ui.bg_element.hex}66` : `${ui.bg_element.hex}77`,
      "editor.wordHighlightBackground": isDark ? `${ui.bg_element.hex}55` : `${ui.bg_element.hex}66`,
      "editor.wordHighlightStrongBackground": isDark ? `${ui.bg_element.hex}77` : `${ui.bg_element.hex}88`,
      ...
      "menu.selectionForeground": ui.text_primary.hex,
      ...
      "quickInputList.focusForeground": ui.text_primary.hex,
